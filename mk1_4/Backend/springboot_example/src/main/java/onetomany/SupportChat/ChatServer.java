...
//        String messageContent = jsonMessage.optString("content");
//
//        if("direct".equals(messageType)) {
//            String destUserName = jsonMessage.optString("recipient");
//            sendMessageToPArticularUser(destUserName, "[DM from " + username + "]: " + messageContent);
//            sendMessageToPArticularUser(username, "[DM to " + destUserName + "]: " + messageContent);
//        } else {
