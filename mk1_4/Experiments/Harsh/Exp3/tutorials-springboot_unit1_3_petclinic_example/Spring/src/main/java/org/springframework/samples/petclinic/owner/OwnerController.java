...
class OwnerController {
    ...
    // function that checkouts new pets
    ...
    public String createDummyData() {
        ...
        Owners o5 = new Owners(5, "Harsh", "Modi", "Underneath the Bridge", "3335-55444-444");
        ownersRepository.save(o1);
        ownersRepository.save(o2);
        ownersRepository.save(o3);
        ownersRepository.save(o4);
        ownersRepository.save(o5);
        return "Successfully created dummy data, ready for testing";
    }
    ...
    @RequestMapping(method = RequestMethod.GET, path = "/checkout/{petsId}")
    public Optional<Pets> findPetById(@PathVariable("petsId") int id) {
        logger.info("Entered into Controller Layer");
