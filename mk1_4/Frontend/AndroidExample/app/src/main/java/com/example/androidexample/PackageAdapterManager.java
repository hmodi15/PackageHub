 ...
 */
public class PackageAdapterManager extends RecyclerView.Adapter<PackageAdapterManager.ViewHolder> {
    private final PackageInteractionListenerManager listener;
     ...
     */
    public PackageAdapterManager(List<Package> packageList, PackageInteractionListenerManager listener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_package_manager, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        String nameText = "Recipient:  " + currentPackage.getOccupantName();
        holder.textOccupantName.setText(nameText);
        String dateText = "Scanned on " + currentPackage.getDeliveryDate();
        ...
        String pickUpText = "Pickup Status: " + currentPackage.getPickUpStatus();
        holder.textPickUpStatus.setText(pickUpText);
        String markDeliveredButtonText = "";
        if(currentPackage.getPickUpStatus() == true){
            markDeliveredButtonText = "Undo Delivery";
        }
        else{
            markDeliveredButtonText = "Mark as Delivered";
        }
        holder.buttonMarkDelivered.setText(markDeliveredButtonText);
        ...
        // Set an OnClickListener for the mark delivered button
        holder.buttonMarkDelivered.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int adapterPosition = holder.getAdapterPosition();
                if (adapterPosition != RecyclerView.NO_POSITION) {
                    //int packageId = packageList.get(adapterPosition).getId();
                    listener.onMarkPackageDelivered(adapterPosition);
                }
            }
        });
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            textPickUpStatus = itemView.findViewById(R.id.textPickUpStatus);
